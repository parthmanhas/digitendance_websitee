...
const Lectures = (props) => {
    ...
    const getData = () => {
        firebase.database().ref(`newteacher/lecture/Sun May 03 2020/new class lecture/attendance`).once('value')
            .then((snap) => {
                const data = snap.val();
                ...
                <ul className='container' style={{ width: 'max-content' }}>
                    {attendance
                        ...
                        attendance.map(obj => {
                            ...
                            return (
                                <div class={obj[key]['attendanceMarked'] && obj[key]['attendanceMarked'] === 'true' ? "card green lighten-1" : "card blue lighten-4"}>
                                    <div class="card-content black-text">
                                        <li className='left-align' style={{width: 500, padding: 5, wordWrap: 'break-word' }}>
                                            ...
                                            <li>Attendance Marked   : {obj[key]['attendanceMarked'] && obj[key]['attendanceMarked'] === 'true' ? "true" : "false"}</li>
                                            {
                                                obj[key]['qrCode']
                                                    ?
